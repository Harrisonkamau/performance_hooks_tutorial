...
handler._user.post = (data, callback) => {
  ...
  if (firstName && lastName && phone) {
    performance.mark('Starting to read users');
    ...
    _data.read('users', phone, (err, data) => {
      ...
      performance.mark('User reading complete');
      if (err) {
        performance.mark('Creating users');
      ...
      performance.mark('User creation complete');
    })
  ...
  // gather all checks
  performance.measure('Sanity Checking', 'Entered Function', 'Inputs validated');
